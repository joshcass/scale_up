...
ActiveRecord::Schema.define(version: 20150915204632) do
  ...
  add_index "loan_requests_contributors", ["user_id", "loan_request_id"], name: "index_loan_requests_contributors_on_user_id_and_loan_request_id", using: :btree
